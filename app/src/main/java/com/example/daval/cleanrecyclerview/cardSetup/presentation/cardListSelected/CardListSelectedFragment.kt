 ...
 * Use the [CardListSelectedFragment.newInstance] factory method to
...
class CardListSelectedFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment CardListSelectedFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CardListSelectedFragment().apply {
